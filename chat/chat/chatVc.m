...
//        static NSString* cellIdentifier = @"identiCell";
        if (!cell) {
...
//        }];
        ...
        /*
        NSString* identifier = [NSString stringWithFormat:@"%ld",self.cellFrames.count-indexPath.row];
        ChartCell* cell = (ChartCell*)[tableView dequeueReusableCellWithIdentifier:identifier];
        if (!cell) {
